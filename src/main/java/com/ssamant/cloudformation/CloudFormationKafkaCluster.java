 ...
 * @author sunil
 */
public class CloudFormationKafkaCluster {
    
    public CloudFormationKafkaCluster(){
    ...
    public static void createCloudFormation(){
        AmazonCloudFormation stackbuilder = AmazonCloudFormationClientBuilder.standard()
            ...
            .build();       
        System.out.println("===========================================");
        System.out.println("Getting Started with AWS CloudFormation for Kafka Cluster");
        System.out.println("===========================================\n");
        String stackName  = "kafkaStackDPP";
        String logicalResourceName = "kafkaservers";
        try {
            // Create a stack
            CreateStackRequest createRequest = new CreateStackRequest();
            createRequest.setStackName(stackName);
            ClassLoader classloader = Thread.currentThread().getContextClassLoader();
            InputStream is = classloader.getResourceAsStream("test.template");
...
//            System.out.println("Stack creation completed, the stack " + stackName + " completed with " + waitForCompletion(stackbuilder, stackName));
    ...
    public static void deleteStack() {
         ...
         String stackName = "kafkaStackDPP";
         String logicalResourceName = "KafkaBrokers";
        try {
            DeleteStackRequest deleteRequest = new DeleteStackRequest();
            deleteRequest.setStackName(stackName);
